...
@section('title', 'Pages des offres')

@section('content')
    <section class="content">
        <div class="box box-success">
            <div class="box-header">Bienvenue sur la page des offres</div>
            <div>
            ...
            <div class="box-body">
                <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Liste des offres sur le marché</h6>
                        </div>
                        <div class="card-body">
