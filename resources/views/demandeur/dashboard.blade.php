...
@section('title', 'Pages des candidatures')

@section('content')
    <section class="content">
        <div class="box box-success">
            <div class="box-header">Bienvenue sur la page des candidatures</div>
            <div>
                <a href="{{ route('demande.create') }}" class="btn btn-primary">Créer une demande</a>
                <a href="{{ route('demande.mes') }}" class="btn btn-secondary">Modifier ou Supprimer mes demandes</a>
            ...
            <div class="box-body">
                <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Liste des candidatures sur le marché</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"><div class="dataTables_length" id="dataTable_length"><label>Show <select name="dataTable_length" aria-controls="dataTable" class="custom-select custom-select-sm form-control form-control-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> entries</label></div></div><div class="col-sm-12 col-md-6"><div id="dataTable_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="dataTable"></label></div></div></div><div class="row"><div class="col-sm-12"><table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                    ...
                                    <tbody> 
                                        ...
                                        <tr class="odd">
                                                ...
                                                <td>{{ $demande->user->email ?? 'Non défini' }}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('follow.toggle') }}" method="POST">
                                                        @csrf
                                                        <input type="hidden" name="followable_id" value="{{ $demande->id }}">
                                                        <input type="hidden" name="followable_type" value="App\Models\Demande">
                                                        <button type="submit" class="btn btn-sm btn-outline-primary">
                                                            {{ auth()->user()->isFollowing($demande) ? 'Ne plus suivre' : 'Suivre' }}
                                                        </button>
                                                    </form>
                                                </td>
                                            </tr>
